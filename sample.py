...
parser.add_argument('--hidden_size', type=int, default=250)  # 128
parser.add_argument('--embed_size', type=int, default=250)  # 128
...
with torch.no_grad():
    for _ in tqdm(range(args.nsample // args.batch_size)):
        smiles_list = model.sample(args.batch_size,args.greedy)
