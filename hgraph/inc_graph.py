...
class IncBase(object):
    ...
    def __init__(self, batch_size, node_fdim, edge_fdim, max_nodes=150, max_edges=300, max_nb=20):
        self.max_nb = max_nb
...
class IncTree(IncBase):
    ...
    def __init__(self, batch_size, node_fdim, edge_fdim, max_nodes=150, max_edges=300, max_nb=20, max_sub_nodes=50):
